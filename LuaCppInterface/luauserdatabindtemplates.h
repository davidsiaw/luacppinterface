	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)() )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET()>(std::tr1::bind(func, t));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0)>(std::tr1::bind(func, t, _1));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1)>(std::tr1::bind(func, t, _1, _2));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1, ARG2) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1,ARG2)>(std::tr1::bind(func, t, _1, _2, _3));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1, ARG2, ARG3) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1,ARG2,ARG3)>(std::tr1::bind(func, t, _1, _2, _3, _4));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1,ARG2,ARG3,ARG4)>(std::tr1::bind(func, t, _1, _2, _3, _4, _5));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1,ARG2,ARG3,ARG4,ARG5)>(std::tr1::bind(func, t, _1, _2, _3, _4, _5, _6));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6)>(std::tr1::bind(func, t, _1, _2, _3, _4, _5, _6, _7));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
	...
	void LuaUserdata<TYPE>::BindYield(std::string name, RET(TYPE::*func)(ARG0, ARG1, ARG2, ARG3, ARG4, ARG5, ARG6, ARG7) )
	{
		...
		TYPE* t = RetrieveData();
		Lua lua(state);
		auto luaFunc = lua.CreateYieldingFunction<RET(ARG0,ARG1,ARG2,ARG3,ARG4,ARG5,ARG6,ARG7)>(std::tr1::bind(func, t, _1, _2, _3, _4, _5, _6, _7, _8));
		LuaTable table = GetMetaTable();
		table.Set(name, luaFunc);
	}
